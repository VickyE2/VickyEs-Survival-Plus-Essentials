...
public abstract class BukkitAdvancement implements PlatformAdvancement {
    ...
    public BukkitAdvancement(
            ...
            @NotNull AdvancementVisibility visibility,
            @NotNull ToastType aTT,
            @NotNull Class<? extends BukkitAdvancement> parentClass
    ) {
        this.description = description;
        this.advancementType = advancementType;
        this.title = title;
    ...
    @Override
    public boolean isEligible(PlatformPlayer platformPlayer) {
        if (platformPlayer instanceof BukkitPlatformPlayer player)
            return isPlayerEligible(player.getBukkitPlayer());
        throw new IllegalArgumentException("Received generic PlatformPlayer instead of BukkitPlatformPlayer");
    }

    @Override
    public void grant(PlatformPlayer platformPlayer) {
        if (platformPlayer instanceof BukkitPlatformPlayer player)
            grantAdvancement(player.getBukkitPlayer());
        else {
            throw new IllegalArgumentException("Received generic PlatformPlayer instead of BukkitPlatformPlayer");
        }
    }

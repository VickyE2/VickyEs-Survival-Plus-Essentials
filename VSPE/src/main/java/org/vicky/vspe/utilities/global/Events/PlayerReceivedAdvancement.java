...
public class PlayerReceivedAdvancement extends Event {
    ...
    private final BukkitAdvancement advancement;

    public PlayerReceivedAdvancement(Player player, BukkitAdvancement advancement) {
        this.player = player;
    ...
    public String getAdvancementDescription() {
        return PlainTextComponentSerializer.plainText().serialize(this.advancement.getDescription());
    }
    ...
    public BukkitAdvancement getAdvancement() {

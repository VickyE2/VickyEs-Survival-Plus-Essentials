...
public class NullDatabaseTrinket extends Exception {
     ...
     */
    public NullDatabaseTrinket(String message, ItemStack itemStack) {
        super(message);
     ...
     */
    public NullDatabaseTrinket(ItemStack itemStack) {
        super();
        this.itemStack = itemStack;
        this.player = null;
    }
     ...
     */
    public NullDatabaseTrinket(String message, Player player) {
        super(message);
        this.itemStack = null;
        this.player = player;
    }
     ...
     */
    public NullDatabaseTrinket(Player player) {
        super();
        this.itemStack = null;
        this.player = player;
    }
     ...
     * @param player    the Player associated with this exception; may be null
     */
    public NullDatabaseTrinket(String message, ItemStack itemStack, Player player) {
        super(message);
        this.itemStack = itemStack;
        this.player = player;
    }
     ...
     * @param player    the Player associated with this exception
     */
    public NullDatabaseTrinket(ItemStack itemStack, Player player) {
        super();
        this.itemStack = itemStack;
        this.player = player;
    }

...
public class SCALE implements NoiseSampler, Ymlable {
    ...
    public SCALE setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public SCALE addGlobalParameter(String parameter, Object value) {

...
public class LINEAR implements NoiseSampler, Ymlable {
    ...
    public LINEAR setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public LINEAR addGlobalParameter(String parameter, Object value) {

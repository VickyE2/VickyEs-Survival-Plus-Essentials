package org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.Generator.utils.Locator.Locators.Patterns;
...
public class Pattern {
    ...
    public Pattern addBlock(PlatformMaterial block, int offset) {
        String key = block.isAir() ? "air"
                : block.getResourceLocation().asString();

...
import org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.dimensions.ChromaticUnderWater.Palettes.MossOceanFloor;
...
public class MysticalCoralReef extends BaseBiome implements Variant {
    public MysticalCoralReef() {
        super(
                "MYSTICAL_CORAL_REEF", 0xFA9BFD, BiomeCategory.WARM_OCEAN, Ocean_Flat.TROPICAL, new Precipitation(0.7F, Precipitation.PrecipitaionType.RAIN), Rarity.LEGENDARY
        );

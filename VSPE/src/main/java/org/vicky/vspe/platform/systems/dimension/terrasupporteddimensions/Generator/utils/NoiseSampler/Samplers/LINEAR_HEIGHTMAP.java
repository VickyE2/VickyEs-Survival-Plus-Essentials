...
public class LINEAR_HEIGHTMAP implements NoiseSampler, Ymlable {
    private final Map<String, Object> values = new HashMap<>();
    private final Map<String, Object> globalValues = new HashMap<>();

    public LINEAR_HEIGHTMAP() {
    }

    // Setter method to set parameters
    public LINEAR_HEIGHTMAP setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public LINEAR_HEIGHTMAP addGlobalParameter(String parameter, Object value) {

package org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.Generator.utils.progressbar.progressbars;
...
public class ConsoleProgressBar implements ProgressListener {
    ...
    public void onProgressUpdate(int progress, String currentProcess) {
        ...
        VSPEPlatformPlugin.platformLogger().info(output.trim());
        if (progress == 100) {
            VSPEPlatformPlugin.platformLogger().info("Done!");
        }
    }
}

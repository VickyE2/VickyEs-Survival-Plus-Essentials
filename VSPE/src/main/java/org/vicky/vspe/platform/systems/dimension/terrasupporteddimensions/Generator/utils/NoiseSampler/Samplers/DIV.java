...
public class DIV implements NoiseSampler, Ymlable {
    ...
    public DIV setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public DIV addGlobalParameter(String parameter, Object value) {

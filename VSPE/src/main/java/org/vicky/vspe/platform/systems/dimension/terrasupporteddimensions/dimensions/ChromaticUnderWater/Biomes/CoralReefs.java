...
import org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.dimensions.ChromaticUnderWater.Features.LargeCorals;
...
public class CoralReefs extends BaseBiome implements BiomeVariant {
    public CoralReefs() {
        super("CORAL_REEF", 0x490976, BiomeCategory.WARM_OCEAN, Ocean_Flat.TROPICAL, new Precipitation(0.7F, Precipitation.PrecipitaionType.RAIN), Rarity.VERY_COMMON);

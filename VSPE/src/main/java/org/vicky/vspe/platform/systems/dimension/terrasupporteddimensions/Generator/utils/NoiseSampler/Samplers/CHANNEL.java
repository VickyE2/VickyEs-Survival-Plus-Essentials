...
public class CHANNEL implements NoiseSampler, Ymlable {
    ...
    public CHANNEL setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public CHANNEL addGlobalParameter(String parameter, Object value) {

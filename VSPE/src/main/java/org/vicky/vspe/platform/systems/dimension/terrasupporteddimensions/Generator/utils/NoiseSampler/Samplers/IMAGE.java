...
public class IMAGE implements NoiseSampler, Ymlable {
    ...
    public IMAGE setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public IMAGE addGlobalParameter(String parameter, Object value) {

...
public class DISTANCE_TRANSFORM implements NoiseSampler, Ymlable {
    ...
    public DISTANCE_TRANSFORM setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public DISTANCE_TRANSFORM addGlobalParameter(String parameter, Object value) {

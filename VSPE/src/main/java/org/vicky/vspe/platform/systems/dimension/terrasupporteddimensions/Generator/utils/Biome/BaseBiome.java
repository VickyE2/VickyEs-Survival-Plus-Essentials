...
import org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.Generator.utils.Biome.type.subEnums.PrecipitaionType;
...
import org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.Generator.utils.Palette.PaletteBuilder;
...
public class BaseBiome {
    ...
    public BaseBiome(String id, Integer biomeColor, BiomeCategory biome, BiomeType biomeType, Precipitation precipitaion, Rarity rarity) {
        this.id = Utilities.getCleanedID(id);
        this.uncleanedId = id;
        this.biome = "minecraft:" + biome.name().toLowerCase();
                ...
                this.ocean = new Ocean.Builder()
                        .setOceanMaterial(
                                new PaletteBuilder("OCEAN_FLOOR")
                                        .addLayer(Map.of(SimpleBlockState.Companion.from("minecraft:water", (it) -> it).getMaterial(), 2), 4)
                                        .build()
                        )

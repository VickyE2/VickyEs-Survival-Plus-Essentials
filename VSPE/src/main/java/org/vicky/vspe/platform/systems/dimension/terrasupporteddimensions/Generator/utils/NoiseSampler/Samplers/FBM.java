...
public class FBM implements NoiseSampler, Ymlable {
    ...
    public FBM setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public FBM addGlobalParameter(String parameter, Object value) {

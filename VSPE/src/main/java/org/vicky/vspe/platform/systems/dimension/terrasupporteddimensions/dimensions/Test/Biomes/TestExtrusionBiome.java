...
import org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.dimensions.Structures.TestExtrusionStructure;
...
import org.vicky.vspe.platform.systems.dimension.terrasupporteddimensions.Generator.utils.Biome.type.subEnums.Cave;
...
public class TestExtrusionBiome extends BaseBiome {
    public TestExtrusionBiome() {
        super("TEST_EXTRUSION_BIOME", 4404583, BiomeCategory.LUSH_CAVES, Cave.SMALL_TEMPERATE, new Precipitation(1.0F, Precipitation.PrecipitaionType.RAIN), Rarity.RARE);
        this.addExtendibles(Extendibles.CAVE, Extendibles.BASE);
        ...
        Feature feature = new Feature("TEST_VINES", FeatureType.CAVE);
        ...
        feature.addStructure(new TestExtrusionStructure(), 10);

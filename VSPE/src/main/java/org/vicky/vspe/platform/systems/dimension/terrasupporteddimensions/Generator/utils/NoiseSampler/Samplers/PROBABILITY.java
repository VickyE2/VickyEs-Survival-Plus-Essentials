...
public class PROBABILITY implements NoiseSampler, Ymlable {
    ...
    public PROBABILITY setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public PROBABILITY addGlobalParameter(String parameter, Object value) {

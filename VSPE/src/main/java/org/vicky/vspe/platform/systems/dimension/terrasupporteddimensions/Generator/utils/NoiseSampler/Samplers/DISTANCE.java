...
public class DISTANCE implements NoiseSampler, Ymlable {
    ...
    public DISTANCE setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public DISTANCE addGlobalParameter(String parameter, Object value) {

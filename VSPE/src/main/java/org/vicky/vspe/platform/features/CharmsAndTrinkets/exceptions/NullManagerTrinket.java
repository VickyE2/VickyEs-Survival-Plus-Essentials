...
public class NullManagerTrinket extends Exception {
     ...
     */
    public NullManagerTrinket(String message, PlatformItem itemStack) {
        super(message);
     ...
     */
    public NullManagerTrinket(PlatformItem itemStack) {
        super();
        this.itemStack = itemStack;
        this.player = null;
    }
     ...
     * @param player    the PlatformPlayer associated with this exception; may be null
     */
    public NullManagerTrinket(String message, PlatformItem itemStack, PlatformPlayer player) {
        super(message);
        this.itemStack = itemStack;
        this.player = player;
    }
     ...
     * @param player    the PlatformPlayer associated with this exception
     */
    public NullManagerTrinket(PlatformItem itemStack, PlatformPlayer player) {
        super();
        this.itemStack = itemStack;
        this.player = player;
    }

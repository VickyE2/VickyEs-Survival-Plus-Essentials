...
public class PING_PONG implements NoiseSampler, Ymlable {
    ...
    public PING_PONG setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public PING_PONG addGlobalParameter(String parameter, Object value) {

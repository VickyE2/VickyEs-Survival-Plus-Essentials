...
public class CLAMP implements NoiseSampler, Ymlable {
    ...
    public CLAMP setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public CLAMP addGlobalParameter(String parameter, Object value) {

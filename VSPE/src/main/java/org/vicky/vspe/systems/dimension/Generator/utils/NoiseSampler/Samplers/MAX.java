...
public class MAX implements NoiseSampler, Ymlable {
    ...
    public MAX setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public MAX addGlobalParameter(String parameter, Object value) {

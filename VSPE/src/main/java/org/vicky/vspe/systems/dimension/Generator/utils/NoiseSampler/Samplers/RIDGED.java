...
public class RIDGED implements NoiseSampler, Ymlable {
    ...
    public RIDGED setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public RIDGED addGlobalParameter(String parameter, Object value) {

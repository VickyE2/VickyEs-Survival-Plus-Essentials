...
public class KERNEL implements NoiseSampler, Ymlable {
    ...
    public KERNEL setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public KERNEL addGlobalParameter(String parameter, Object value) {

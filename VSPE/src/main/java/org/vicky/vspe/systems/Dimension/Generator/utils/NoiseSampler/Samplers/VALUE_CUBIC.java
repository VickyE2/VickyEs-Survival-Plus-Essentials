...
public class VALUE_CUBIC implements NoiseSampler, Ymlable {
    ...
    public VALUE_CUBIC setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public VALUE_CUBIC addGlobalParameter(String parameter, Object value) {

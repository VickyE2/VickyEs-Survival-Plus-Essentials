...
public class TestExtrusionBiome extends BaseBiome {
    public TestExtrusionBiome() {
        ...
        addPalettes(palette1, new TestMeta().getMappingFor(MetaClass.MetaVariables.yLevel));
        addPalettes(palette2, new TestMeta().getMappingFor(MetaClass.MetaVariables.PALETTE_TOP_DEEPSLATE));
        ...
        addFeaturesToParam(List.of(feature), Featureable.FLORA);
    }

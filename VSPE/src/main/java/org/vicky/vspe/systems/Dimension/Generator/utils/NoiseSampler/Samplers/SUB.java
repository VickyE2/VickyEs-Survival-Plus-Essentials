...
public class SUB implements NoiseSampler, Ymlable {
    ...
    public SUB setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public SUB addGlobalParameter(String parameter, Object value) { 

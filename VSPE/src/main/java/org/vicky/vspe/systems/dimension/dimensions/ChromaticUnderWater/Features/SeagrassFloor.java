...
public class SeagrassFloor extends Feature {
    public SeagrassFloor() {
        ...
        pattern2.addSubPattern(new Pattern(Pattern.Type.MATCH).addBlock(Material.SAND, -1));
        pattern2.addSubPattern(new Pattern(Pattern.Type.MATCH).addBlock(Material.WATER, 1));

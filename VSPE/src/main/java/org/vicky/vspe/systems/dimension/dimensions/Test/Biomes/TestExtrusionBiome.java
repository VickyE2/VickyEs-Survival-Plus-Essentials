...
public class TestExtrusionBiome extends BaseBiome {
    public TestExtrusionBiome() {
        super("TEST_EXTRUSION_BIOME", 4404583, Biome.LUSH_CAVES, Cave.SMALL_TEMPERATE, new Precipitation(1.0F, Precipitation.PrecipitaionType.RAIN), Rarity.RARE);
        ...
        pattern.addSubPattern(new Pattern(Pattern.Type.MATCH).addBlock(Material.AIR, 0));

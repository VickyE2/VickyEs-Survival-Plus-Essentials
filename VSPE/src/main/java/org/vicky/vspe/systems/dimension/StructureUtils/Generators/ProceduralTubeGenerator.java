 ...
 */
public class ProceduralTubeGenerator extends ProceduralStructureGenerator {
    ...
    private final BlockState coralMaterial, waterMaterial;

    public ProceduralTubeGenerator(Builder b) {
    ...
    public static class Builder {
        ...
        private BlockState coralMaterial;
        private BlockState waterMaterial;

        public Builder heightRange(int min, int max) { heightMin = min; heightMax = max; return this; }
        public Builder tubeRadius(int r) { tubeRadius = r; return this; }
        public Builder wallThickness(int t) { wallThickness = t; return this; }
        public Builder slope(double coef) { slopeCoef = coef; return this; }
        public Builder flareStart(double percent) { flareStartPercentage = percent; return this; }
        public Builder rimCap(boolean inc) { includeRimCap = inc; return this; }
        public Builder reservoir(boolean inc, int radius) { includeReservoir = inc; reservoirRadius = radius; return this; }
        public Builder materials(BlockState coral, BlockState water) { coralMaterial = coral; waterMaterial = water; return this; }

        // TODO : Config to change these vales for more "wachiness"
        public ProceduralTubeGenerator build() {

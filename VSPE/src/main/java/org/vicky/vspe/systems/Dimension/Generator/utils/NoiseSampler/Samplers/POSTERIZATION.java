...
public class POSTERIZATION implements NoiseSampler, Ymlable {
    ...
    public POSTERIZATION setParameter(String parameter, Object value) {
        this.values.put(parameter, value);
        return this;
    }

    public POSTERIZATION addGlobalParameter(String parameter, Object value) { 

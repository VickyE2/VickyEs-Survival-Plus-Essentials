...
public class AdvancementManager {
    ...
    public final eu.endercentral.crazy_advancements.manager.AdvancementManager ADVANCEMENT_MANAGER
            = new eu.endercentral.crazy_advancements.manager.AdvancementManager(
    ...
    public void processAdvancements() {
        ...
        Set<Class<? extends BaseAdvancement>> advancementClasses = reflections.getSubTypesOf(BaseAdvancement.class);
        ...
        SORTED_ADVANCEMENTS = new Advancement[LOADED_ADVANCEMENTS.size()];

        for (BaseAdvancement advancement : LOADED_ADVANCEMENTS) {
        ...
        ADVANCEMENT_MANAGER.addAdvancement(SORTED_ADVANCEMENTS);
    }

    public void saveManagerProgress() {
        for (OfflinePlayer player : Bukkit.getOfflinePlayers()) {
            ADVANCEMENT_MANAGER.saveProgress(player.getUniqueId());
        }
    }
    ...
    public void saveAndUnloadManagerProgress() {
        for (OfflinePlayer player : Bukkit.getOfflinePlayers()) {
            ADVANCEMENT_MANAGER.saveProgress(player.getUniqueId());
            ADVANCEMENT_MANAGER.unloadProgress(player.getUniqueId());
            ADVANCEMENT_MANAGER.loadProgress(player.getUniqueId());
        }
    }
    ...
    public void grantAdvancemet(Class<? extends BaseAdvancement> advancementClass, Player player) {
        Optional<BaseAdvancement> contextAdvancementOptional = LOADED_ADVANCEMENTS.stream()
        ...
        if (contextAdvancementOptional.isPresent()) {
            ...
            ADVANCEMENT_MANAGER.grantAdvancement(player, contextAdvancement.getInstance());
        } else {

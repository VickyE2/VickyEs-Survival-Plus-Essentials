...
import org.vicky.vspe.nms.file.serializers.VectorSerializer;
...
public interface Serializer<T> {
    ...
    default void tryPathTo(Configuration filledMap, String pathWhereToStore, String pathTo) {
        ...
        if (!this.getClass().isInstance(obj)) {
            ...
            PlatformPlugin.logger().debug("Tried to use path to, but didn't find correct object.\n" +
     ...
     * serializer. For example, the {@link VectorSerializer} should

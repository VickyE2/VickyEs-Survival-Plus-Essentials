...
import org.vicky.vspe.nms.file.serializers.ColorSerializer;
import org.vicky.vspe.nms.utils.MinecraftVersions;
import org.vicky.vspe.nms.utils.ray.BlockTraceResult;
import org.vicky.vspe.nms.utils.ray.EntityTraceResult;
import org.vicky.vspe.nms.utils.ray.RayTraceResult;
...
public class HitBox {
    ...
    private static final Particle DUST_PARTICLE = MinecraftVersions.TRAILS_AND_TAILS.get(5).isAtLeast() ? Particle.REDSTONE : Particle.valueOf("REDSTONE");

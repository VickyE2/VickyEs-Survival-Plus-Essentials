...
import org.vicky.vspe.nms.CompatibilityAPI;
...
public final class ReflectionUtil {
    ...
    static {
        ...
        try {
            ...
            javaVersion1 = -1;
            PlatformPlugin.logger().error("Could not get Java version for '" + System.getProperty("java.version") + "'");
            PlatformPlugin.logger().error("Error: ", throwable);
        }
